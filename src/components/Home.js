...
const Home = props => {
  const toShop = () => {
    props.history.push('/shop/accessories');
  };
  ...
  return (
    <div className="homeContainer">
      <div className="homeMainImageContainer">
        <Grid container spacing={0} align="center">
          <Grid item xs={12} sm={12} md={6}>
            <img alt="placeholder" onClick={toShop} src="imgs/mensad1.gif" />
          </Grid>
          <Grid item xs={12} sm={12} md={6}>
            <h2> New Arrivals </h2>
            <p>
      ...
      <div className="homeSecondaryImageContainer">
        <Grid container spacing={0} align="center">
          <Grid item xs={12} sm={12} md={6}>
            <img onClick={toShop} alt="placeholder" src="imgs/mensad1.jpg" />
            <button onClick={toShop}>See More</button>
          </Grid>
          <Grid item xs={12} sm={12} md={6}>
            <img onClick={toShop} alt="placeholder" src="imgs/mensad2.jpg" />
            <button onClick={toShop}>See More</button>
          </Grid>
        </Grid>
      </div>
      <div className="homeMainImageContainer">
        <Grid container spacing={0} align="center">
          <Grid item xs={12} sm={12} md={6}>
            <img onClick={toShop} alt="placeholder" src="imgs/mensad3.jpg" />
          </Grid>
          <Grid item xs={12} sm={12} md={6}>
            <h2> Featured </h2>
            <p>
